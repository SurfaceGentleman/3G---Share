...
- (void)viewDidLoad {
    ...
    _tableView1 = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) style:UITableViewStyleGrouped];
    _tableView1.delegate = self;
    _tableView1.dataSource = self;
    _tableView1.tag = 101;    //  1
    [self.scrollView addSubview:_tableView1];
    _tableView2 = [[UITableView alloc] initWithFrame:CGRectMake(self.view.frame.size.width, 0, self.view.frame.size.width, self.view.frame.size.height) style:UITableViewStyleGrouped];
    _tableView2.delegate = self;
    _tableView2.dataSource = self;
    _tableView2.tag = 102;
    [self.scrollView addSubview:_tableView2];
    _tableView3 = [[UITableView alloc] initWithFrame:CGRectMake(self.view.frame.size.width * 2, 0, self.view.frame.size.width, self.view.frame.size.height) style:UITableViewStyleGrouped];
...
- (void)creatData
{
    _t = [NSArray arrayWithObjects:@"匆匆那年", @"关于设计反馈的5件事", @"脸书VS人人", @"字体故事", nil];
    _names = [NSArray arrayWithObjects:@"share小白", @"share小白", @"share小白", @"share小白", nil];
    _detail = [NSArray arrayWithObjects:@"原创-摄影-联系习作", @"设计文章-原创-理论", @"设计文章-原创-Web/Flash", @"设计文章-经验-设计观点",  nil];
    _times = [NSArray arrayWithObjects:@"10分钟前", @"16分钟前", @"17分钟前", @"45分钟前", nil];
    _imag = [NSArray arrayWithObjects:@"list_img1", @"note_img1", @"note_img2", @"note_img3", nil];
